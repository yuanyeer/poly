...
class PaperConfig:
    ...
    # REVIEW (escalate-to-finance): dd >= review_pct OR equity < hard floor.
    # HARD HALT (stop scanning): dd >= halt_pct OR equity < hard floor.
    # Do not silently raise the 10% review trigger to the 25% kill line.
